...
class VisInstrEncoder(nn.Module):
    def __init__(self, config):
        super().__init__()
...
class GlocalTextPathNavCMT(BertPreTrainedModel):
    def __init__(self, config):
        ...
        self.vis_instr_encoder = VisInstrEncoder(config)
    ...
    def forward_vis_instr(self, batch_vis_instrs, batch_indexes, batch_floors):
        instr_embeds = self.vis_instr_encoder(batch_vis_instrs, batch_indexes, batch_floors)
        return instr_embeds

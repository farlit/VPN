...
class ETP(Net):
    def __init__(
        ...
        self.rgb_encoder = VitEncoder(self.device)
    ...
    def forward(self, mode=None, 
                ...
                vis_instrs=None, indexes=None, floors=None,
                ):
        ...
        if mode == 'language':
            ...
            vis_instr_embeds, masks = self.vln_bert.forward_vis_instr(vis_instrs, indexes, floors)

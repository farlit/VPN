...
def parse_args():
    ...
    parser.add_argument('--prompt_enhance', action='store_true', default=False)
    parser.add_argument('--agent_enhance', action='store_true', default=False)
    parser.add_argument("--hm3d", default=None)
...
def postprocess_args(args):
    ...
    # }
    ft_file_map = {
        'vitbase': 'hf_vit_base_224_in21k_mp3d_hm3d.hdf5',
    }
    ...
    args.connectivity_dir = os.path.join(ROOTDIR, 'R2R', 'connectivity_mp3d_hm3d')
    args.scan_data_dir = os.path.join(ROOTDIR, 'Matterport3D', 'v1_unzip_scans')

    args.anno_dir = os.path.join(ROOTDIR, 'R2R', 'trajectories')
    args.mp3d_floor_dir = os.path.join(args.anno_dir, 'mp3d_floors')
    args.hm3d_floor_dir = os.path.join(args.anno_dir, 'hm3d_floors')
    args.test_vp_dir = os.path.join(args.anno_dir, 'test_visual_prompts')
